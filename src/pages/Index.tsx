...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="section-padding pt-32 container-padding overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center animate-fade-in">
            <h1 className="text-foreground mb-6 max-w-4xl mx-auto">
              Create the perfect
              <span className="text-primary block">cover letter</span>
              in seconds
            </h1>
      ...
      <footer className="py-16 px-6 bg-muted/30 border-t border-border/50">
        <div className="max-w-7xl mx-auto text-center">
          <div className="flex items-center justify-center space-x-2 mb-6">
            ...
            <span className="text-lg font-semibold text-foreground">CoverCraft</span>
          </div>
          <p className="text-muted-foreground mb-8">
            Empowering job seekers with AI-powered cover letter generation
          </p>
